...
struct_format = 'iiiiifff6s16s16s16s6s20s'
throttle = -1
steer = -1
...
while True:
    ...
    (counter, throttle, throttle_out, steer, sig_strength, ax, ay, az, device_mac, local_ip, gateway_ip, subnet_mask, bssid, ssid) = unpack(struct_format, data)
